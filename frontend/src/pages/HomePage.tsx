...
import { homepageInlineCta } from "../data/homepageMarketingContent";
  ...
  return (
    <>
      ...
      <div className="pg-home hm-home" id="home">
        ...
        <HomeMarketingInlineCta {...homepageInlineCta.default} />
        <HomeMarketingFeatureHighlights />
        <HomeMarketingReportsSection />
        <HomeMarketingInlineCta {...homepageInlineCta.afterReports} />
