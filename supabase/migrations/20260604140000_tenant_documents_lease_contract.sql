-- Lease signed contract: optional document per lease, visible on tenant statement → Documents.
...
-- ---------------------------------------------------------------------------
-- list_tenant_documents_owner: applicant docs + lease contracts for this tenant
-- ---------------------------------------------------------------------------
