-- Patch: include lease id on INCOME statement rows.
-- This enables "Generate invoice" actions for EXPECTED rent lines without changing schema or RLS.
-- Only change vs 20260525100000_get_property_monthly_statement_rpc.sql:
--   inc_rows: `NULL::text AS lease_id_txt` -> `i.lease_id::text AS lease_id_txt`
